...
├── tools/config-generator/                                # Python config generator
├── Makefile
├── central-control-plane-applications/                    # ArgoCD Applications
│   ├── central-control-plane-pipelines.application.yaml   # Deploys the cluster management pipeline
...
└── providers/
    ├── aws/                                               # AWS provider
    │   ├── provision-application/                         # ArgoCD app for deploying `provision/` chart
    │   ├── provision/                                     # Helm chart for AWS resources
    │   └── pipeline-tasks/
    │       ├── pre.yaml                                   # Pre-provision task
    │       ├── provision.yaml                             # Provision task
    │       └── post.yaml                                  # Post-provision task
    └── <other-providers>/
```
